...
const $categoryBtns = document.querySelectorAll('.lct-category-btn');
const $lectureCards = document.querySelectorAll('.lct-lecture-card');
const $categoryList = document.querySelector('.lct-category-list');
const $searchInput = document.querySelector('.lct-search-input');
...
$searchInput.addEventListener('keydown', (event) => {
    if (event.key === 'Enter') {
        ...
        // const preview = card.querySelector('.lct-lecture-preview').textContent.toLowerCase();         //만약 요약으로도 검색하게 할 거라면
